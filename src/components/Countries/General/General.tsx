...
const GeneralCont = () => {
    ...
    return (
      <S.Nigeria>
        ...
        <S.ButtonContainer>
          <S.Button href={`/general/scene/1`}>{translations.country.read} 1</S.Button>
          <S.Button href={`/general/scene/2`}>{translations.country.read} 2</S.Button>
          <S.Button href={`/general/scene/3`}>{translations.country.read} 3</S.Button>
        </S.ButtonContainer>
      </S.MovieInfo>
